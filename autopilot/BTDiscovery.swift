    ...
    if let central = centralManager {
      ...
      print(peripherals.count)
        if(peripherals.count > 0){
            ...
            self.bleService = nil
            central.connect(peripherals[0], options: nil)
        }
    }
  }
*/
  ...
  func centralManager(_ central: CBCentralManager, didDiscoverPeripheral peripheral: CBPeripheral,  rssi: NSNumber) {
